 ...
 */
module.exports = async function(url, userAgent, device, second) {
    ...
    if(device){
        ...
        await page.emulate(deviceSettings);
    }

    return await page.goto(fullUrl, {waitUntil: 'networkidle0',timeout: second * 1000});
};